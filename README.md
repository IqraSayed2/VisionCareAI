...
## Medical Disclaimer
This application provides preliminary screening results only. All diagnoses should be confirmed by qualified medical professionals. The AI analysis is not a substitute for clinical examination.

## License
This project is for educational and research purposes. Please consult medical professionals for actual healthcare decisions.